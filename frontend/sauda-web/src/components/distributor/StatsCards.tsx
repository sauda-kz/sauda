...
export function StatsCards({ totalMatches, inStockCount = 150 }: StatsCardsProps) {
  return (
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-2 text-3xl font-bold text-slate-900">1 428</p>
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="mt-2 text-3xl font-bold text-slate-900">{inStockCount}</p>
